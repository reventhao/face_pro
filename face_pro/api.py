...
def loading_models():
    global predictor_68_point_model
    predictor_68_point_model = pose_predictor_model_location()
    global predictor_5_point_model
    ...
    global cnn_face_detection_model
...
def get_face_encoding(face_image, face_locations=None):
    ...
    """
    face_encoding = face_encodings(face_image, face_locations)
...
def contrast_faces(known_image, unknown_image, tolerance=0.4):
    ...
    try:
        ...
        result = compare_faces([known_image_encoding], unknown_image_encoding, tolerance)
        return result
    except IndexError:
        return "nf"
    ...
    while True:
        ...
        if process_this_frame:
            ...
            for face_encoding in face_encodings:
                matches = compare_faces(known_face_encodings, face_encoding, tolerance)
                name = "Unknown"
